...
object InitFlinkEnv {
  ...
  /**
    ...
    */
  def initFlinkStreamEnv(timeCharacteristic: TimeCharacteristic, checkPoint: Option[Int]=None, checkpointingMode: CheckpointingMode = CheckpointingMode.EXACTLY_ONCE): StreamExecutionEnvironment = {
